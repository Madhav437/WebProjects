 ...
 <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
     <div class="jumbotron jumbotron-fluid">
			  <div class="container">
			   <div class="row">
			   	<div class="col-md-6 my-auto" >
			   		 <h1>Tesla Electric Car - Order Confirmation</h1>
			   	</div>
      ...
      <div class="row">
     <strong> Order Id  : </strong> <c:out value="${newOrdId}"/> <br> <br>
     </div>
     <div class="row">
     ...
     <strong>Auto pilot : </strong><c:out value="${autopilot}"/> <br> <br>
      ...
      <div class="row">
     <strong>Payment : </strong><c:out value="${confPayment}"/> <br> <br> 
       </div>
     <div class="row">
     ...
     <form method="post" action="<c:url value="/carPdf.htm" />">
    <div class="row">
          	<div class="col-md-12">
          		<input type="submit" name="button" class="btn btn-outline-primary btn-lg"   value="PDF Download" />
          	</div>
          </div>
